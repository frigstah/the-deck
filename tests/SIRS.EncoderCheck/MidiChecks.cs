...
internal static class MidiChecks
{
    public static int Run()
    {
        ...
        failures += Check("the messages SIRS acts on are decoded, and the rest ignored", () =>
        {
        ...
        failures += Check("a damaged settings line loses only the damaged part", () =>
        {
            ...
            // Hand-edited, half-written, or carried from a newer version of SIRS.
        ...
        failures += Check("a real MIDI device opens and closes cleanly", () =>
        {
            ...
            {
                // Exclusive access: another program already has it. Not a fault in SIRS, and the
