...
/// is already in use is a normal state of the world and not a fault in SIRS.
/// </para>
/// </summary>
internal static class AsioChecks
{
    public static int Run()
    {
        ...
        failures += Check("a machine with no ASIO drivers still works", () =>
        {
            ...
            // here would stop SIRS opening on any machine with a broken ASIO registry entry.
        ...
        failures += Check("an ASIO id can never be mistaken for a Windows endpoint", () =>
        {
            ...
            // A WASAPI endpoint id is a GUID-shaped string. It must not be taken for ASIO, or SIRS
        ...
        failures += Check("a real ASIO driver opens and delivers audio", () =>
        {
            ...
            // interface is busy is a normal state of the world, not a bug in SIRS.
