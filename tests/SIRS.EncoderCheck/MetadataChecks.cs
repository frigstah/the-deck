...
/// directly, because the thing worth proving is that a playout system pointed at SIRS gets through.
/// </summary>
internal static class MetadataChecks
{
    public static int Run()
    {
        ...
        {
            // An automation system already configured for Icecast should reach SIRS by changing only
