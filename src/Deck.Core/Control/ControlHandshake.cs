...
/// <summary>
/// How <c>Deck.exe --live</c> finds the copy of Deck already running (I10).
/// <para>
...
public static class ControlHandshake
{
    ...
    /// <summary>
    /// Where the running Deck is listening, or null if none is. A file left behind by a crash names
