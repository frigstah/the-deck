...
/// <summary>A command line asking a running Deck to do something (I10).</summary>
...
public static class CommandLine
{
    public const string HelpText =
        ...
        Run Deck with no arguments to open the window. With any of these, Deck instead sends the
        command to the copy already running and prints the answer:

          --status              show what Deck is doing
        ...
        The control endpoint has to be switched on first, under "Deck itself" in the window.
        """;

    /// <summary>
    /// Null means there was no command and Deck should open normally. Anything else should be sent
        ...
        for (var i = 0; i < args.Length; i++)
        {
            ...
            switch (name)
            {
                ...
                case "--title":
                {
                    ...
                    {
                        return Bad("--title needs some text, for example: Deck --title \"Artist - Song\"");
                    }
                ...
                case "--gain":
                {
                    ...
                    {
                        return Bad("--gain needs a number of decibels, for example: Deck --gain -3");
                    }
