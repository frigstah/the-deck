...
{
    /// <summary>
    /// Decodes a raw MIDI event. Returns null for anything Deck does not act on - clock, aftertouch,
...
/// <summary>One control on the desk wired to one thing in Deck.</summary>
...
/// <summary>
/// Maps a MIDI desk onto Deck (I11).
/// <para>
/// The decoding and the dispatch live here, apart from any device, so the whole of it can be checked
/// by feeding raw bytes in. That matters more than usual: MIDI hardware is the one thing in Deck
...
public sealed class MidiControl
{
    ...
    /// case, since a desk sends far more than Deck is listening for.
    /// </summary>
