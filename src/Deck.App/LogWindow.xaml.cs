...
public partial class LogWindow : Window
{
    ...
    private void OnCopyAll(object sender, RoutedEventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            MessageBox.Show($"Deck could not copy the log: {ex.Message}", "The Deck");
        }
    }
    ...
    private void OnOpenFolder(object sender, RoutedEventArgs e)
    {
        ...
        {
            MessageBox.Show("There is no log folder on this computer yet.", "The Deck");
            return;
        }
        ...
        {
            MessageBox.Show($"Deck could not open the log folder: {ex.Message}", "The Deck");
        }
    }
