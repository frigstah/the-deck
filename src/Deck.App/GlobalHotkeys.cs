...
/// going live or muting yourself should not require finding the Deck window first.
/// <para>
...
public sealed class GlobalHotkeys : IDisposable
{
    ...
    public void Attach(Window window, Action toggleBroadcast, Action toggleMute)
    {
        ...
        if (failures.Count > 0)
        {
            Problem = $"Deck could not claim {string.Join(" or ", failures)} — another program is already using it.";
        }
    }
