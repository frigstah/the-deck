    ...
    string? FieldNaming = null)
{
    ...
    public static HostPreset Generic { get; } = new(
        "I'm not sure — let SIRS work it out",
        ServerType.Unknown,
        "Fill in the address, port and password your host gave you, then press Test. SIRS will identify the server itself.");
    ...
    [
        ...
        new("SHOUTcast v2",
            ...
            DefaultPort: 8000,
            FieldNaming: "SHOUTcast calls the stream a \"stream ID\" or \"SID\". It is usually 1. If your host quoted the listener port, SIRS will move to the broadcast port for you."),
