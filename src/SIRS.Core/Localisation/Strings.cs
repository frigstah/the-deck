...
namespace Sirs.Core.Localisation;
    ...
    private static LanguagePack EnglishPack() => new()
    {
        ...
        Entries = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            [StringId.AdviceNoSignalHint] =
                "Nothing is reaching SIRS. Check the input is the right device, that it is plugged in, and that it is not muted in Windows.",
            ...
            // ---- updates (I9)
            [StringId.UpdateUpToDate] = "SIRS is up to date.",
            [StringId.UpdateAvailable] = "SIRS {0} is available. You are running {1}.",
            [StringId.UpdateCheckFailed] = "SIRS could not check for updates: {0}",
