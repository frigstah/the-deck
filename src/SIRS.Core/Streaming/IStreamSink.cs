...
{
    /// <summary>
    /// Anything worth telling the user about how the connection was made - for example that SIRS
...
public static class SinkFactory
{
    public static IStreamSink Create(ServerProfile profile, EncoderSettings encoder) => profile.ServerType switch
    {
        ...
        _ => throw new StreamException(
            ...
            "SIRS does not know what kind of server this is yet. Open the server settings and press Test, and it will work it out."),
    };
}
